import "../../styles/iPad/IpadChapterNav.css";

const IpadChapterNav = () => {
  return (
    <div className="ipad-charpter-nav-container">
      <div className="ipad-charpter-nav-wrapper">
        <div className="ipad-header-items">
          <img
